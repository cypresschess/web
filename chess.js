news_feed ( 
{
   "items" : [
      {
         "description" : "Romanian grandmaster Bogdan-Daniel Deac won the Reykjavik Open after scoring 7&frac12;/9 points, leaving seven players tied for second place a half point back. According to tiebreak criteria, Sebastian Maze from France and Paulius Pultinevicius from Lithuania grabbed second and third place, respectively. Deac entered the event as the rating favourite, and obtained clear first place after scoring back-to-back wins in the final two rounds. | Photo: Hallfr&iacute;̡ur Sigur̡ard&oacute;ttir",
